	...
	public T create(Object... objects)
	{
		...
		else if (objects.length == 1)
		{
			...
			else if (objects[0].getClass() == TypeCompte.class)
			{
				...
				{
					return (T) new Compte(numTemp, (String) objects[0]);
				}
				else if (this.type == CompteRemunere.class)
				{
					return (T) new CompteRemunere(numTemp, (String) objects[0]);
				}
				else if (this.type == CompteASeuil.class)
				{
					return (T) new CompteASeuil(numTemp, (String) objects[0]);
				}
				else if (this.type == CompteASeuilRemunere.class)
				{
					return (T) new CompteASeuilRemunere(numTemp, (String) objects[0]);
				}
			}
		}
		else if (objects.length == 2)
		{
			...
			else if (objects[0].getClass() == TypeCompte.class)
			{
				if (this.type == Compte.class)
				{
					return (T) new Compte(numTemp, (String) objects[0], (Double) objects[1]);
				}

				else if (this.type == ICompteRemunere.class)
				{
					return (T) new CompteRemunere(numTemp, (String) objects[0], (Float) objects[1]);
				}
				else if (this.type == ICompteASeuil.class)
				{
					return (T) new CompteASeuil(numTemp, (String) objects[0], (Double) objects[1]);
				}
			}
		}
		else if (objects.length == 3)
		{
			...
			else if (objects[0].getClass() == TypeCompte.class)
			{
				...
				{
					return (T) new CompteRemunere(numTemp, (String) objects[0], (Double) objects[1],
							(Float) objects[2]);
				}
				else if (this.type == ICompteASeuil.class)
				{
					return (T) new CompteASeuil(numTemp, (String) objects[0], (Double) objects[1], (Double) objects[2]);
				}
			}
		}
		else if (objects.length == 4)
		{
			...
			{
				return (T) new CompteASeuilRemunere(numTemp, (String) objects[0], (Double) objects[1],
						(Float) objects[2], (Double) objects[3]);
			}
		}
